...
export default function ContactForm() {
  ...
  const onSubmit = async (data: FormData) => {
    // 향후 실제 이메일 전송이나 DB 저장 API를 연결할 자리입니다.
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input 
                type="text" 
                {...register("name")}
                className="w-full p-4 bg-neutral-50 border border-neutral-200 focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 transition-colors"
                placeholder="홍길동"
              />
          ...
          <div>
            ...
            <select 
              {...register("service")}
              className="w-full p-4 bg-neutral-50 border border-neutral-200 focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 transition-colors appearance-none"
            >
          ...
          <div>
            ...
            <textarea 
              {...register("details")}
              rows={5}
              className="w-full p-4 bg-neutral-50 border border-neutral-200 focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 transition-colors resize-none"
